(function(){
  ...
  function copyFixes(){
    ...
    var s = document.querySelectorAll('.stamp');
    for (var k = 0; k < s.length; k++)
      s[k].innerHTML = s[k].innerHTML.replace(/House of Dasani/gi, 'Dasani Family');
  }
  ...
  function run(){ copyFixes(); boost(); wireCues(); }
  if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', copyFixes); else copyFixes();
